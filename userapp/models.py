...
class StudentRegModel(models.Model):
    ...
    class_selected = models.CharField(max_length=2, choices=[(str(i), f'Class {i}') for i in range(1, 13)])
    class Meta:
...
class StudentFeedback(models.Model):
    ...
    sentiment = models.CharField(max_length=20)  # Add this field for sentiment
